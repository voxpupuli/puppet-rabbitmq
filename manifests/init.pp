...
class rabbitmq(
  ...
  Rabbitmq::Absolutepath $config_path                                                                = $rabbitmq::params::config_path,
  ...
  Rabbitmq::Absolutepath $env_config_path                                                            = $rabbitmq::params::env_config_path,
  ...
  Rabbitmq::Absolutepath $rabbitmq_home                                                              = $rabbitmq::params::rabbitmq_home,
