...
class rabbitmq(
  ...
  Variant[Rabbitmq::Absolutepath, String] $config_path                                                                = $rabbitmq::params::config_path,
  ...
  Variant[Rabbitmq::Absolutepath, String] $env_config_path                                                            = $rabbitmq::params::env_config_path,
  ...
  Variant[Rabbitmq::Absolutepath, String] $rabbitmq_home                                                              = $rabbitmq::params::rabbitmq_home,
  ...
  Optional[Rabbitmq::Absolutepath] $ssl_cacert                                                       = undef,
  Optional[Rabbitmq::Absolutepath] $ssl_cert                                                         = undef,
  Optional[Rabbitmq::Absolutepath] $ssl_key                                                          = undef,
  ...
  Optional[Rabbitmq::Absolutepath] $ssl_dhfile                                                       = undef,
